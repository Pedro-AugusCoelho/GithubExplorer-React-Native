    ...
    <Background>
      <Container>
        ...
        <RepoStats>
          <Stars>
            <StarsCounter>{
              repository.stargazers_count // TODO - repository stargazers count
            }</StarsCounter>
          ...
          <Forks>
            <ForksCounter>{
              repository.forks_count // TODO - repository forks count
            }</ForksCounter>
          ...
          <OpenIssues>
            <OpenIssuesCounter>{
              repository.issues.length // TODO - repository issues count
            }</OpenIssuesCounter>
        ...
        <IssuesList
          ...
          renderItem={({ item: issue }) => (
            <Card
              ...
              onPress={() => handleIssueNavigation(issue.html_url)}// TODO - onPress prop calling 
            />
          )}
        />
      </Container>
